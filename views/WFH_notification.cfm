...
<!--- invokes --->
<!--- <cfinvoke component="models.leaves" method="getwfhapproved" returnvariable="wfh_history"> --->
...
<!--- <div class="card shadow p-3 alert alert-warning container" style="margin-top:100px;MAX-HEIGHT:50PX;width: 300PX;" role="alert"> --->
		...
		<!--- <table class="table table-striped border-dark container" style="overflow: hidden;">
					...
					<div class="card shadow p-3 alert alert-warning container my-5" style="margin-top:100px;HEIGHT:50PX;width: 400PX;" role="alert">
