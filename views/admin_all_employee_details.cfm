          	...
          	<div class="col-sm-12 col-md-12 col-lg-12 page-heading mb-4">
				<section id="contact" class="contact">
			            <div class="section-title">
						        ...
						        <h3 class="text-secondary" style="font-weight: bold;">#getprofile.first_name# #getprofile.last_name#</h3>
						      </div>
					                ...
					                <div class="col-lg-4 p-3">
					                	<h6>Joining Date</h6>
					                		<cfif getprofile.employee_joining_date NEQ "">
					                			<span class="font_style">#dateformat(getprofile.employee_joining_date, 'dd-mmm-yyyy')#</span>
					                		<cfelse>
					                			<span class="font_style_NA">NA</span>
					                		</cfif>
					                </div>
					                <div class="col-lg-4 p-3">
					                	<h6>Relieving Date</h6>
					                		<cfif getprofile.employee_relieving_date NEQ "">
					                			<span class="font_style">#dateformat(getprofile.employee_relieving_date, 'dd-mmm-yyyy')#</span>
					                		<cfelse>
					                			<span class="font_style_NA">NA</span>
					                		</cfif>
					                </div>
