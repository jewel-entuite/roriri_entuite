...
<cfif structKeyExists(URL, "p_id") AND URL.p_id NEQ "">
	<cfinvoke component="models.timesheet" method="getdetails" p1="#url.p_id#" id="#decrypt(url.employeeid, 'RHMm64ACs6qftCFBz4j+5Q==', 'AES','HEX')#"year="#url.year#" month="#url.month#" module="#url.module#" FSdate="#url.FSdate#" FEdate="#url.FEdate#" status="#url.status#" req="#url.req#" assgn="#url.assgn#"  returnvariable="list"/>
<cfelse>
	<cfinvoke component="models.timesheet" method="getdetails" id="#decrypt(url.employeeid, 'RHMm64ACs6qftCFBz4j+5Q==', 'AES','HEX')#"year="#url.year#" month="#url.month#" module="#url.module#" FSdate="#url.FSdate#" FEdate="#url.FEdate#" status="#url.status#" req="#url.req#" assgn="#url.assgn#"  returnvariable="list"/>
</cfif>
<cfelseif structKeyExists(url, "emp_id") AND url.emp_id NEQ "" AND structKeyExists(url, "employeeid") AND url.employeeid EQ "">
	<cfif structKeyExists(URL, "p_id") AND URL.p_id NEQ "">
		<cfinvoke component="models.timesheet" method="getdetails" p1="#url.p_id#" id="#decrypt(url.emp_id, 'RHMm64ACs6qftCFBz4j+5Q==', 'AES','HEX')#"year="#url.year#" month="#url.month#" module="#url.module#" FSdate="#url.FSdate#" FEdate="#url.FEdate#" status="#url.status#" req="#url.req#" assgn="#url.assgn#"  returnvariable="list"/>
<cfelse>
		<cfinvoke component="models.timesheet" method="getdetails" id="#decrypt(url.emp_id, 'RHMm64ACs6qftCFBz4j+5Q==', 'AES','HEX')#"year="#url.year#" month="#url.month#" module="#url.module#" FSdate="#url.FSdate#" FEdate="#url.FEdate#" status="#url.status#" req="#url.req#" assgn="#url.assgn#"  returnvariable="list"/>
	</cfif>
</cfif>
			...
			<body style="font-family: Calibri;">
				<table class="text-center listing-table" border="1" width="100%" cellspacing="0" cellpadding="3" style="border-collapse:collapse;">
					<thead style="color: ##1C4587">
						...
						<tr><th colspan="8" style="font-size:16px;">
							<b>
								<cfif structKeyExists(URL, "p_id") AND URL.p_id NEQ ""> 
